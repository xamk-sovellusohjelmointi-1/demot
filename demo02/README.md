# Demo 2: React-perusteita - Tehtävälista

Opintojakson toisessa demossa tehdään toinen klassinen ohjelmointitehtävä, eli tehtävälista. Tällä tehtävällä havainnollistetaan muun muassa, miten Reactissa hallitaan tilamuuttujilla erilaisia tietorakenteita (arrayt, objektit...). Toinen asia, mitä harjoitellaan, on erilaisten tietorakenteiden tulostaminen React-sovelluksessa/jsx-merkkauksessa.
